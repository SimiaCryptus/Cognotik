...
class UpdateModePolicy(private val global: UpdateMode) {
  ...
  companion object {
    private val log = LoggerFactory.getLogger(UpdateModePolicy::class.java)
  }
}
...
class TaskKindPolicy<K : DocTaskKind>(private val kinds: DocTaskKindResolver<K>) {
  ...
  companion object {
    private val log = LoggerFactory.getLogger(TaskKindPolicy::class.java)
  }
}
...
class RootPolicy(private val root: File) {
  ...
  companion object {
    private val log = LoggerFactory.getLogger(RootPolicy::class.java)
  }
}
...
class TaskConfigPolicy {
  ...
  companion object {
    private val log = LoggerFactory.getLogger(TaskConfigPolicy::class.java)
  }
}