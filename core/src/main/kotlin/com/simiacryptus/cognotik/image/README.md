...
This package provides a unified interface and implementations for generating images using various AI providers,
specifically Google Gemini (Imagen) and OpenAI (DALL-E).
