package com.simiacryptus.cognotik.docops.model
    ...
    /**
     * A canonicalized target location plus a case-normalized [key] used for map identity.
     *
     * Replaces every `normalizePath()` / `groupBy { ... } / re-key with original path` block that used
     * to be smeared across [com.simiacryptus.cognotik.docops.DocProcessorBase].
     */
