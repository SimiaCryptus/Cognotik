...
class IterativePatchUtilTest {
    ...
    fun testPatchExactMatch() {
        ...
        val patch = """
            ...
            line3
        """.trimIndent()
        val result = FuzzyPatchMatcher.default.applyPatch(source, patch)
    ...
    fun testGeneratePatchNoChanges() {
        val oldCode = "line1\nline2\nline3"
        val newCode = oldCode
        val result = FuzzyPatchMatcher.default.generatePatch(oldCode, newCode)
        val expected = ""
        Assertions.assertEquals(normalize(expected), normalize(result))
    }
    ...
    fun testGeneratePatchMoveLineUpwardsMultiplePositions() {
        ...
        val actualPatch = FuzzyPatchMatcher.default.generatePatch(oldCode, newCode)
