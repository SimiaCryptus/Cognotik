...
object ConversationalModeTest {
   ...
   //@org.junit.jupiter.api.Test
    fun test() {
        object : PlanHarness(
            prompt = "Create a simple python script that prints 'Hello from ConversationalMode'",
            cognitiveSettings = CognitiveModeType.Chat.newSettings(),
        ) {
