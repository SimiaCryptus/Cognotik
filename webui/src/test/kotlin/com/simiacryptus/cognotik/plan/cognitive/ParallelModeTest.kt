...
object ParallelModeTest {
   ...
   //@org.junit.jupiter.api.Test
    fun test() {
        object : PlanHarness(
            prompt = "Create a simple python script that prints 'Hello from ParallelMode'",
            cognitiveSettings = CognitiveModeType.Parallel.newSettings(),
        ) {
