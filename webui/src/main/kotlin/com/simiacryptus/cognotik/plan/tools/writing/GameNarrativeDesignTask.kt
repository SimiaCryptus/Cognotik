...
Provide specific examples and recommendations for improvement.
      ...
      val designDocument = buildString {
        ...
        appendLine("---")
        appendLine()
        appendLine("**Document Generated:** ${LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"))}")
      }
      ...
      task.safeComplete("Game narrative design complete: ${gameNarrative.characters.size} characters, ${gameNarrative.branching_points.size} branching points, ${gameNarrative.endings.size} endings in ${totalTime / 1000}s", log)
