...
mechanicsTask.add(
        ...
        progressionTask.add(
          buildString {
            ...
            progression.forEach { level ->
              ...
              appendLine("- **Estimated Playtime:** ${String.format("%.1f", level.estimated_playtime_hours)} hours")
              appendLine()
      ...
      val finalResult = buildString {
        ...
        appendLine("- **Balance Score:** ${String.format("%.0f", balance.skill_expression_score)}/100 skill, ${String.format("%.0f", balance.luck_factor_score)}/100 luck")
