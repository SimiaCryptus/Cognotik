...
Provide the complete revised paper.
      ...
      val finalPaper = buildString {
        ...
        appendLine()
        appendLine("**Paper Generated:** ${LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"))}")
      }
      ...
      task.safeComplete("Research paper generation complete: $cumulativeWordCount words in ${totalTime / 1000}s", log)
