...
class NeuralNetworkLayerTask(
    ...
    companion object {
        ...
        val NeuralNetworkLayer = TaskType(
            ...
            "Design and analyze neural network layers with formal mathematical definitions and implementations",
            """
                Comprehensive neural network layer design and analysis tool.
                <ul>
    ...
    override fun promptSegment(): String {
        return """
 NeuralNetworkLayer - Design and analyze neural network layers with formal mathematical definitions
    ...
    override fun run(
        ...
        try {
            ...
            val overviewContent = buildString {
                ...
                appendLine("## Progress")
                appendLine()
                appendLine("- ⏳ Generating formal definition...")
            }
            ...
            val resultMessage = buildString {
                ...
                appendLine("- **Input Gradient:** $${gradients.gradient_input_latex}$")
                appendLine("- **Implementations:** ${languages.joinToString(", ")}")
                appendLine("- **Novelty:** ${originality.novelty_assessment.take(100)}...")
                appendLine("- **Primary Domains:** ${useCases.primary_domains.take(3).joinToString(", ")}")
                appendLine()
                appendLine("See tabs for detailed analysis including gradients, stability, implementations, originality, and use cases.")
            }
