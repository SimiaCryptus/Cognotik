          ...
          """.trimIndent(),
                ...
                plotPoints.take(3).forEach { point ->
                    resultBuilder.append(
                        "- **${point.type}:** ${
                            point.description.truncateForDisplay(
          ...
          """.trimIndent(),
                ...
                if (inconsistencies.isNotEmpty()) {
                    ...
                    inconsistencies.take(3).forEach { inconsistency ->
                        resultBuilder.append(
                            "- **${inconsistency.type}:** ${
                                inconsistency.description.truncateForDisplay(
                                    maxDescriptionLength
                                )
                            }\n"
                        )
...
Be concise but insightful. Focus on actionable insights.
        """.trimIndent(),
            ...
            task.safeComplete(
                "Narrative analysis complete in ${totalTime / 1000}s. Results saved to .narrative_analysis directory.",
                log
            )
