...
Many services in this package are configured via `ApplicationServicesConfig`. The `ApplicationServices` object supports
a locking mechanism (`isLocked`) to prevent modification of core services after the application has initialized.
