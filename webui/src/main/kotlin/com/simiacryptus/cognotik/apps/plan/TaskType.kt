...
import com.simiacryptus.cognotik.apps.plan.tools.CommandAutoFixTask.CommandAutoFixTaskConfigData
import com.simiacryptus.cognotik.apps.plan.tools.RunShellCommandTask.RunShellCommandTaskConfigData
import com.simiacryptus.cognotik.apps.plan.tools.file.FileModificationTask.FileModificationTaskConfigData
import com.simiacryptus.cognotik.apps.plan.tools.file.InquiryTask.InquiryTaskConfigData
import com.simiacryptus.cognotik.apps.plan.tools.plan.ForeachTask.ForeachTaskConfigData
import com.simiacryptus.cognotik.apps.plan.tools.plan.PlanningTask.PlanningTaskConfigData
  ...
  companion object {
    val SoftwareGraphPlanningTask = TaskType(
      "SoftwareGraphPlanningTask",
        com.simiacryptus.cognotik.apps.plan.tools.graph.SoftwareGraphPlanningTask.GraphBasedPlanningTaskConfigData::class.java,
    ...
    val DataTableCompilationTask = TaskType(
      "DataTableCompilationTask",
        com.simiacryptus.cognotik.apps.plan.tools.knowledge.DataTableCompilationTask.DataTableCompilationTaskConfigData::class.java,
      TaskSettingsBase::class.java,
    ...
    val SoftwareGraphModificationTask = TaskType(
      "SoftwareGraphModificationTask",
        com.simiacryptus.cognotik.apps.plan.tools.graph.SoftwareGraphModificationTask.SoftwareGraphModificationTaskConfigData::class.java,
      TaskSettingsBase::class.java,
    ...
    val SoftwareGraphGenerationTask = TaskType(
      "SoftwareGraphGenerationTask",
        com.simiacryptus.cognotik.apps.plan.tools.graph.SoftwareGraphGenerationTask.SoftwareGraphGenerationTaskConfigData::class.java,
      TaskSettingsBase::class.java,
    ...
    val FileSearchTask = TaskType(
      "FileSearchTask",
        com.simiacryptus.cognotik.apps.plan.tools.file.FileSearchTask.SearchTaskConfigData::class.java,
      TaskSettingsBase::class.java,
    ...
    val EmbeddingSearchTask = TaskType(
      "EmbeddingSearchTask",
        com.simiacryptus.cognotik.apps.plan.tools.knowledge.EmbeddingSearchTask.EmbeddingSearchTaskConfigData::class.java,
      TaskSettingsBase::class.java,
    ...
    val CommandAutoFixTask = TaskType(
      ...
      CommandAutoFixTaskConfigData::class.java,
        com.simiacryptus.cognotik.apps.plan.tools.CommandAutoFixTask.CommandAutoFixTaskSettings::class.java,
    ...
    val GitHubSearchTask = TaskType(
      "GitHubSearchTask",
        com.simiacryptus.cognotik.apps.plan.tools.online.GitHubSearchTask.GitHubSearchTaskConfigData::class.java,
      TaskSettingsBase::class.java,
    ...
    val KnowledgeIndexingTask = TaskType(
      "KnowledgeIndexingTask",
        com.simiacryptus.cognotik.apps.plan.tools.knowledge.KnowledgeIndexingTask.KnowledgeIndexingTaskConfigData::class.java,
      TaskSettingsBase::class.java,
    ...
    val SeleniumSessionTask = TaskType(
      "SeleniumSessionTask",
        com.simiacryptus.cognotik.apps.plan.tools.SeleniumSessionTask.SeleniumSessionTaskConfigData::class.java,
      TaskSettingsBase::class.java,
    ...
    val CommandSessionTask = TaskType(
      "CommandSessionTask",
        com.simiacryptus.cognotik.apps.plan.tools.CommandSessionTask.CommandSessionTaskConfigData::class.java,
      TaskSettingsBase::class.java,
    ...
    val WebSearchTask = TaskType(
      "CrawlerAgentTask",
        com.simiacryptus.cognotik.apps.plan.tools.online.CrawlerAgentTask.SearchAndAnalyzeTaskConfigData::class.java,
      TaskSettingsBase::class.java,
    ...
    init {
        registerConstructor(SoftwareGraphPlanningTask) { settings, task ->
            com.simiacryptus.cognotik.apps.plan.tools.graph.SoftwareGraphPlanningTask(
                settings,
                task
            )
        }
        registerConstructor(SoftwareGraphModificationTask) { settings, task ->
            com.simiacryptus.cognotik.apps.plan.tools.graph.SoftwareGraphModificationTask(
                settings,
                task
            )
        }
        registerConstructor(SoftwareGraphGenerationTask) { settings, task ->
            com.simiacryptus.cognotik.apps.plan.tools.graph.SoftwareGraphGenerationTask(
                settings,
                task
            )
        }
        registerConstructor(DataTableCompilationTask) { settings, task ->
            com.simiacryptus.cognotik.apps.plan.tools.knowledge.DataTableCompilationTask(
                settings,
                task
            )
        }
        registerConstructor(CommandAutoFixTask) { settings, task ->
            com.simiacryptus.cognotik.apps.plan.tools.CommandAutoFixTask(
                settings,
                task
            )
        }
        registerConstructor(InquiryTask) { settings, task ->
            com.simiacryptus.cognotik.apps.plan.tools.file.InquiryTask(
                settings,
                task
            )
        }
        registerConstructor(FileSearchTask) { settings, task ->
            com.simiacryptus.cognotik.apps.plan.tools.file.FileSearchTask(
                settings,
                task
            )
        }
        registerConstructor(WebSearchTask) { settings, task ->
            com.simiacryptus.cognotik.apps.plan.tools.online.CrawlerAgentTask(
                settings,
                task
            )
        }
        registerConstructor(EmbeddingSearchTask) { settings, task ->
            com.simiacryptus.cognotik.apps.plan.tools.knowledge.EmbeddingSearchTask(
                settings,
                task
            )
        }
        registerConstructor(FileModificationTask) { settings, task ->
            com.simiacryptus.cognotik.apps.plan.tools.file.FileModificationTask(
                settings,
                task
            )
        }
        registerConstructor(RunShellCommandTask) { settings, task ->
            com.simiacryptus.cognotik.apps.plan.tools.RunShellCommandTask(
                settings,
                task
            )
        }
        registerConstructor(ForeachTask) { settings, task ->
            com.simiacryptus.cognotik.apps.plan.tools.plan.ForeachTask(
                settings,
                task
            )
        }
        registerConstructor(TaskPlanningTask) { settings, task ->
            com.simiacryptus.cognotik.apps.plan.tools.plan.PlanningTask(
                settings,
                task
            )
        }
        registerConstructor(GitHubSearchTask) { settings, task ->
            com.simiacryptus.cognotik.apps.plan.tools.online.GitHubSearchTask(
                settings,
                task
            )
        }
        registerConstructor(KnowledgeIndexingTask) { settings, task ->
            com.simiacryptus.cognotik.apps.plan.tools.knowledge.KnowledgeIndexingTask(
                settings,
                task
            )
        }
        registerConstructor(SeleniumSessionTask) { settings, task ->
            com.simiacryptus.cognotik.apps.plan.tools.SeleniumSessionTask(
                settings,
                task
            )
        }
        registerConstructor(CommandSessionTask) { settings, task ->
            com.simiacryptus.cognotik.apps.plan.tools.CommandSessionTask(
                settings,
                task
            )
        }
