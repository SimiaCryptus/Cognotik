...
class SessionsServlet : HttpServlet() {
    ...
    override fun doGet(req: HttpServletRequest, resp: HttpServletResponse) {
        ...
        when (resolveFormat(req)) {
            Format.JSON -> writeJson(resp, user, sessionMetadata, sessionParents, parentSessionIds)
            Format.HTML -> writeHtml(resp, user, sessionMetadata, sessionParents, parentSessionIds)
        }
    }
