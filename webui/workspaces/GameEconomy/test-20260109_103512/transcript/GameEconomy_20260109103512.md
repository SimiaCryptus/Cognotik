...
- **Fuel** (Operational Resource)
- **Raw Materials** (Tier 1-4 Materials)
- **Components** (Crafted Goods)
- **Nova Credits** (Premium Currency)

### Progression System
- Levels: 3
- Estimated time to max: Long-term

### Loot Tables (2)
- Ship Salvage: 2 drops
- Null-Sec Exploration: 1 drops

### Monetization
- Model: Time or Money, but not Power
- Pay-to-win risk: Low

### Engagement Hooks (3)
- The Galactic Exchange (Player-driven Market)
- Community Goals (World Event)
- Territory Control (Meta-game)

### Balance Recommendations
- The Newbie Buffer: Ensure starter systems have infinite low-tier nodes to prevent veteran starvation of entry-level economy.
- Risk-Adjusted Returns: Profit-per-hour in Null-Sec must be at least 2.5x higher than High-Sec.
- Anti-Hoarding Tax: Implement progressive Hangar Fees for players holding massive amounts of raw materials.
- Monitor Gold-to-Bread Ratio: Track the price of basic ammo against average hourly income to ensure accessibility.


---
**Design completed in 152s**
**Finished:** 2026-01-09 10:37:44
