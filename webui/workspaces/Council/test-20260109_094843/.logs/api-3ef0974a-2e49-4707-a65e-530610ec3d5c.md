...
* [DEBUG] [1048.541] 
<details>
<summary>Sending request to Gemini SDK for model: gemini-3-flash-preview (681234cb-060f-4036-a404-51dd9532e1ba)</summary>
...
* [DEBUG] [1051.253] 
<details>
<summary>Gemini SDK Response (681234cb-060f-4036-a404-51dd9532e1ba)</summary>
...
```text
    ...
    {
      "votes" : [ 4, 6, 1 ],
      "reasoning" : "The user provided the indices 4, 6, and 1."
    }
    |```
```
...
* [DEBUG] [1051.254] Usage recorded for session: null, user: null, model: gemini-3-flash-preview, tokens: Usage(prompt_tokens=194, completion_tokens=47, total_tokens=579, cost=5.729999999999999E-5)
