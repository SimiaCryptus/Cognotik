...
* [DEBUG] [1733.392] 
<details>
<summary>Sending request to Gemini SDK for model: gemini-3-flash-preview (cf90a060-b1b6-4af0-99cb-3f05fc80d587)</summary>
...
* [DEBUG] [1735.622] 
<details>
<summary>Gemini SDK Response (cf90a060-b1b6-4af0-99cb-3f05fc80d587)</summary>
...
```text
    ...
    {
      "votes" : [ 2, 4 ],
      "reasoning" : "The user selected tasks 2 and 4."
    }
    |```
```
...
* [DEBUG] [1735.622] Usage recorded for session: null, user: null, model: gemini-3-flash-preview, tokens: Usage(prompt_tokens=191, completion_tokens=39, total_tokens=462, cost=5.205E-5)
