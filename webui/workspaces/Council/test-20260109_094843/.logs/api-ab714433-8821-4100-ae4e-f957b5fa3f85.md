...
* [DEBUG] [859.731] 
<details>
<summary>Sending request to Gemini SDK for model: gemini-3-flash-preview (335103e6-6a3f-422b-9d31-ce2d3e796551)</summary>
...
* [DEBUG] [861.872] 
<details>
<summary>Gemini SDK Response (335103e6-6a3f-422b-9d31-ce2d3e796551)</summary>
...
```text
    ...
    {
      "votes" : [ 2, 3 ],
      "reasoning" : "The user explicitly stated their preference for tasks 2 and 3."
    }
    |```
```
...
* [DEBUG] [861.873] Usage recorded for session: null, user: null, model: gemini-3-flash-preview, tokens: Usage(prompt_tokens=197, completion_tokens=43, total_tokens=423, cost=5.535E-5)
