...
* [DEBUG] [1592.913] 
<details>
<summary>Sending request to Gemini SDK for model: gemini-3-flash-preview (59414443-d1b1-4470-ae68-fba5a1a3e38e)</summary>
...
* [DEBUG] [1594.851] 
<details>
<summary>Gemini SDK Response (59414443-d1b1-4470-ae68-fba5a1a3e38e)</summary>
...
```text
    ...
    {
      "votes": [1, 2],
      "reasoning": "The user selected tasks 1 and 2."
    }
    |```
```
...
* [DEBUG] [1594.851] Usage recorded for session: null, user: null, model: gemini-3-flash-preview, tokens: Usage(prompt_tokens=191, completion_tokens=36, total_tokens=427, cost=5.0249999999999995E-5)
