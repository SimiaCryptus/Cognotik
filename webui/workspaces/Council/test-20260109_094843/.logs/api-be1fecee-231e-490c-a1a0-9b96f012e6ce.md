...
* [DEBUG] [1609.331] 
<details>
<summary>Sending request to Gemini SDK for model: gemini-3-flash-preview (e2e885db-3421-4676-9d9e-39192f6a7d32)</summary>
...
* [DEBUG] [1611.441] 
<details>
<summary>Gemini SDK Response (e2e885db-3421-4676-9d9e-39192f6a7d32)</summary>
...
```text
    ...
    {
      "votes" : [ 2, 3 ],
      "reasoning" : "The user selected tasks 2 and 3."
    }
    |```
```
...
* [DEBUG] [1611.441] Usage recorded for session: null, user: null, model: gemini-3-flash-preview, tokens: Usage(prompt_tokens=191, completion_tokens=39, total_tokens=433, cost=5.205E-5)
