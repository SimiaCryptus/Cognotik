...
* [DEBUG] [1680.867] 
<details>
<summary>Sending request to Gemini SDK for model: gemini-3-flash-preview (dce0641b-c945-4db3-bdba-87c1f9482c00)</summary>
...
* [DEBUG] [1694.302] 
<details>
<summary>Gemini SDK Response (dce0641b-c945-4db3-bdba-87c1f9482c00)</summary>
        ...
        "files": [
          {
            ...
            "goal": "Ensure the script is the simplest possible implementation, containing only the single line: print('Hello from CouncilMode')"
          },
          {
            "relative_path": "README.md",
            "goal": "Simplify the documentation to only include the command to run the script, removing all narrative and redundant file references."
          }
        ],
        "input_files": []
      }
...
* [DEBUG] [1694.302] Usage recorded for session: null, user: null, model: gemini-3-flash-preview, tokens: Usage(prompt_tokens=6595, completion_tokens=126, total_tokens=8675, cost=0.0010648499999999998)
