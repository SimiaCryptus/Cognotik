...
* [DEBUG] [1694.309] 
<details>
<summary>Sending request to Gemini SDK for model: gemini-3-flash-preview (48f2e57e-4d3f-4c96-b18e-fffde8ff2523)</summary>
...
* [DEBUG] [1708.770] 
<details>
<summary>Gemini SDK Response (48f2e57e-4d3f-4c96-b18e-fffde8ff2523)</summary>
      ...
      "tasks": [
        {
          ...
          "task_description": "Update hello.py and README.md to simplify their content",
          "state": "Pending",
          "task_dependencies": [],
          "files": [
            "hello.py",
          ...
          "modifications": {
            "hello.py": "Ensure the script is the simplest possible implementation, containing only the single line: print('Hello from CouncilMode')",
            "README.md": "Simplify the documentation to only include the command to run the script, removing all narrative and redundant file references."
          },
...
* [DEBUG] [1708.770] Usage recorded for session: null, user: null, model: gemini-3-flash-preview, tokens: Usage(prompt_tokens=819, completion_tokens=179, total_tokens=3350, cost=2.3024999999999999E-4)
