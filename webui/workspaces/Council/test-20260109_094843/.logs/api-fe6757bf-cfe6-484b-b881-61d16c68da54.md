...
* [DEBUG] [1461.389] 
<details>
<summary>Sending request to Gemini SDK for model: gemini-3-flash-preview (a95afc24-39d0-4c3e-b11c-e49433a65f78)</summary>
...
* [DEBUG] [1463.681] 
<details>
<summary>Gemini SDK Response (a95afc24-39d0-4c3e-b11c-e49433a65f78)</summary>
...
```text
    ...
    {
      "votes": [1, 2],
      "reasoning": "The user explicitly selected tasks 1 and 2."
    }
    |```
```
...
* [DEBUG] [1463.681] Usage recorded for session: null, user: null, model: gemini-3-flash-preview, tokens: Usage(prompt_tokens=191, completion_tokens=37, total_tokens=453, cost=5.084999999999999E-5)
