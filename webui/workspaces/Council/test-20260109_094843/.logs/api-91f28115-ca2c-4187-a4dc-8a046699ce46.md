...
* [DEBUG] [1024.226] 
<details>
<summary>Sending request to Gemini SDK for model: gemini-3-flash-preview (d9d29d81-f3e5-48c6-84bf-997359e66711)</summary>
...
* [DEBUG] [1026.515] 
<details>
<summary>Gemini SDK Response (d9d29d81-f3e5-48c6-84bf-997359e66711)</summary>
...
```text
    ...
    {
      "votes": [ 1, 6 ],
      "reasoning": "The user selected tasks 1 and 6."
    }
    |```
```
...
* [DEBUG] [1026.516] Usage recorded for session: null, user: null, model: gemini-3-flash-preview, tokens: Usage(prompt_tokens=191, completion_tokens=37, total_tokens=452, cost=5.084999999999999E-5)
