...
### Core Loop
The Resonance Cycle: A loop consisting of exploration and attunement to Fractures, engaging in combat or social challenges, making a Shard Decision (Order, Freedom, or Dominion), and experiencing a World Shift that alters physical laws and traversal.

### Key Systems
- Resonance Combat System: Alignment-based combat styles (Order, Freedom, Dominion) affecting magic and tactics.
- Living World Dialogue System: NPC reactions based on Ideological Pressure and the 'Shard’s Whisper' power options.
- Shard-Forging: A crafting system where gear is infused with Shard light to gain alignment-specific properties.

### Progression
The Shard-Link: A living skill tree with three branches (The Architect, The Catalyst, The Sovereign) featuring lock-out mechanics and stat evolution that physically transforms the player and the environment.

### Unique Mechanics
- The Laws of Eldoria: A system where the player's moral compass literally changes the game's physics engine.
- The Gravity Shift: Weakened gravity and increased verticality tied to the Freedom alignment.
- The Chronos Effect: Time manipulation and predictability mechanics tied to the Order alignment.
- The Entropy Tax: Resource scarcity and exponential power growth tied to the Dominion alignment.

### Ludonarrative Harmony
The Weight of Choice: Gameplay reinforces themes of Order vs. Freedom and the Corruption of Power by making Dominion an 'easy mode' with social isolation, Freedom a high-risk/unpredictable path, and Order a safe but stagnant experience.
...
### 1. sunken_temple_shard

**Location:** The Sunken Temple

**Description:** The first Shard is found. It powers a village's water but is needed for the journey.

**Choices:**

#### Choice: Extract the Shard
- **Tone:** Pragmatic/Ruthless

**Consequences:**
- Gain immediate power/level up
- The village suffers
...
#### Choice: Leave the Shard
- **Tone:** Altruistic

**Consequences:**
- The village thrives
- Party remains weak
- Must take a dangerous detour

**Character Reactions:**
- **Lyra:** +1
- **Kaelen:** -1

**Convergence Point:** Crossroads Camp

---

### 2. great_schism

**Location:** Act 2 Start

**Description:** The player must choose which faction to officially provide their services to.

**Choices:**

#### Choice: Align with the Scholars
- **Tone:** 

**Consequences:**
- Mission objective: Protect

**Unlocks:** Magic upgrades, Lore access


#### Choice: Align with the Unbound
- **Tone:** 

**Consequences:**
- Mission objective: Sabotage

**Unlocks:** Stealth tech, Combat maneuvers
...
**Consequences:**
- Harder gameplay
- Keeps all ending options open

**Convergence Point:** Whispering Woods

---

### 3. mercy_of_the_woods

**Location:** Whispering Woods

**Description:** Lyra is captured. Kaelen wants to use her as a battery to find the final shard.

**Choices:**

#### Choice: Allow the Ritual
- **Tone:** 

**Consequences:**
- Lyra is permanently weakened/scarred
- Final location revealed instantly
...
**Consequences:**
- Lyra becomes a temporary ally
- Kaelen leaves the party for a chapter


#### Choice: Negotiate a Truce
- **Tone:** 
...
**Locks:** Requires high Persuasion stat

**Convergence Point:** Iron Gates

---

### 4. siege_of_the_spire

**Location:** The Spire

**Description:** Deciding the method of entry into the final fortress.

**Choices:**

#### Choice: Frontal Assault
- **Tone:** 
...
#### Choice: The Secret Passage
- **Tone:** 

**Consequences:**
- Requires sacrifice of a powerful item/shard
- Low combat, high puzzle difficulty

**Convergence Point:** Chamber of Echoes
...
**Description:** The final decision for the fate of Eldoria.

**Choices:**

#### Choice: Reforge the Crystal
- **Tone:** 
...
#### Choice: Consume the Power
- **Tone:** 

**Consequences:**
- Take the energy for yourself
