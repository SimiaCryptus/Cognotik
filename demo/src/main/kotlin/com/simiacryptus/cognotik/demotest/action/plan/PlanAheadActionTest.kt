package com.simiacryptus.cognotik.demotest.action.plan
...
class PlanAheadActionTest : DemoTestBase(
    ...
    companion object {
        ...
        private const val TASK_RUNNER_XPATH =
            "//div[contains(@class, 'ActionMenuItem') and contains(@text, 'Task Runner')]"
    }
