package com.simiacryptus.cognotik.demotest.action.chat
            ...
            if (url != null) {
                ...
                try {
                    ...
                    try {
                        ...
                        MultiCodeChatActionTest.log.warn(
                            "Copy button not found within the expected time. Skipping copy action.",
                            e
                        )
