...
object MistralModels {
   ...
   */
  val MagistralMedium1_2 by lazy {
    ChatModel(
   ...
   */
  val MistralSmallCreative by lazy {
    ChatModel(
   ...
   */
  val MagistralMedium1_1 by lazy {
    ChatModel(
