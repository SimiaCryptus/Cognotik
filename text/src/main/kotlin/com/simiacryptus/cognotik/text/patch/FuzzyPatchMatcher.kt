...
open class FuzzyPatchMatcher(
  ...
  private fun isMatch(
    ...
    // Check for code block markers
    val sourceIsCodeBlock = sourcePrev.line?.trimStart()?.startsWith("${PatchProcessor.TRIPLE_TILDE}") ?: false
    val patchIsCodeBlock = patchPrev.line?.trimStart()?.startsWith("${PatchProcessor.TRIPLE_TILDE}") ?: false
