        ...
        try {
            ...
            task.ui.pool.submit {
                try {
                    ...
                    val result = audioAgent.answer(listOf(AudioAndText(text = audioPrompt)) + inputAudios)
                    val generatedAudio = result.audio ?: throw RuntimeException("No audio generated by the agent")
                    ...
                    val saveAction = {
                        ...
                        val audioBytes = Base64.getDecoder().decode(generatedAudio.data)
                        outputPath.toFile().writeBytes(audioBytes)
