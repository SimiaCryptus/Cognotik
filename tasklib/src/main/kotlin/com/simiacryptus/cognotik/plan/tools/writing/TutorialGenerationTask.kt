  ...
  ** Produces publication-ready tutorial with clear, actionable steps
  ...
  override fun run(
    ...
    task.ui.pool.submit {
      ...
      val executionConfig = executionConfig ?: TutorialGenerationTaskExecutionConfigData().apply {
        task.safeComplete("CONFIGURATION ERROR: Missing execution configuration", log)
        resultFn("CONFIGURATION ERROR: Missing execution configuration")
        return@submit
      }
