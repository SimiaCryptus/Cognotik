...
abstract class CognitiveSchemaStrategy(
  ...
  companion object {
    ...
    init {
      register(CognitiveSchemaStrategy::class.java, ProjectManager)
      register(CognitiveSchemaStrategy::class.java, ScientificMethod)
      register(CognitiveSchemaStrategy::class.java, AgileDeveloper)
      register(CognitiveSchemaStrategy::class.java, CriticalAuditor)
      register(CognitiveSchemaStrategy::class.java, CreativeWriter)
    }

    fun values() = values(CognitiveSchemaStrategy::class.java)
    fun valueOf(name: String) = valueOf(CognitiveSchemaStrategy::class.java, name)
  }
