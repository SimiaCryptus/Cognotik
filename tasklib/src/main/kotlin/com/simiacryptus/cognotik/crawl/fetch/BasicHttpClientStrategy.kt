...
open class BasicHttpClientStrategy(private val task: CrawlerAgentTask) : FetchStrategy {
  override fun fetch(
    url: String,
    webSearchDir: File,
    index: Int,
    ...
    val content = when {
      ...
      contentType.startsWith("text/html") || contentType.isEmpty() -> {
        ...
        readHtml(url, webSearchDir, body)
      }
      ...
      isDocument(contentType) -> {
        ...
        readDocument(contentType, url, webSearchDir, index, bytes)
      }
  ...
  private fun isDocument(contentType: String): Boolean = contentType.startsWith("application/pdf") ||
  ...
  private fun readHtml(url: String, webSearchDir: File, body: String): String {
    ...
    val simplified = simplifyHtml(body, url)
    ...
    return processHtmlContent(body, url, webSearchDir, task)
  }
