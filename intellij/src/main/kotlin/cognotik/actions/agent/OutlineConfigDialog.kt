...
import cognotik.actions.ModelSelectionDialog
...
class OutlineConfigDialog(
    ...
    data class OutlineSettings(
        val expansionSteps: List<ExpansionStep> = listOf(
            ExpansionStep(AppSettingsState.instance.smartChatModel),
            ExpansionStep(AppSettingsState.instance.smartChatModel)
        ),
        ...
        val parsingModel: ChatModel = AppSettingsState.instance.smartChatModel
    )
}