...
(function() {
     ...
     */
    async function runDocOp(sessionId, opPath, targetPath, models = {}) {
     ...
     */
    async function fetchDocopsStatus(basePath) {
        try {
     ...
     */
    async function waitForTask(basePath, targetPath, maxWaitMs = 600000, onStatusUpdate = null) {
     ...
     */
    function createStatusPoller(basePath, onUpdate, interval = 3000) {
        let timer = null;
