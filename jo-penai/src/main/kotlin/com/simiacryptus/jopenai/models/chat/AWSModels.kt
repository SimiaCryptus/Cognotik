...
object AWSModels {
    ...
    val AWSLLaMA31_405bChat = ChatModelType(
    ...
    val AWSLLaMA31_70bChat = ChatModelType(
    ...
    val AWSLLaMA31_8bChat = ChatModelType(
    ...
    val Mistral7bInstructV02 = ChatModelType(
    ...
    val Mixtral8x7bInstructV01AWS = ChatModelType(
    ...
    val MistralLarge2402 = ChatModelType(
    ...
    val MistralLarge2407 = ChatModelType(
    ...
    val AmazonTitanTextLiteV1 = ChatModelType(
    ...
    val AmazonTitanTextExpressV1 = ChatModelType(
    ...
    val Claude3OpusAWS = ChatModelType(
        name = "Claude3OpusAWS",
    ...
    val CohereCommandTextV14 = ChatModelType(
    ...
    val AI21J2UltraV1 = ChatModelType(
        name = "AI21J2UltraV1",
    ...
    val LLaMA38bInstructAWS = ChatModelType(
    ...
    val LLaMA370bInstructAWS = ChatModelType(
    ...
    val AmazonNovaProV1 = ChatModelType(
    ...
    val AmazonNovaLiteV1 = ChatModelType(
    ...
    val AmazonNovaMicroV1 = ChatModelType(
    ...
    val DeepseekLLMR1DistillQwen32b = ChatModelType(
