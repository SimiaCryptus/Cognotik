...
object GeminiImageModels {
  val Imagen3Generate = ImageModel(
    name = "Imagen3Generate", modelName = "imagen-3.0-generate-002", maxPrompt = 2048, provider = APIProvider.Gemini, pricingFunction = { width, height ->
  ...
  val Imagen4Generate = ImageModel(
    name = "Imagen4Generate", modelName = "imagen-4.0-generate-001", maxPrompt = 2048, provider = APIProvider.Gemini, pricingFunction = { width, height ->
  ...
  val Imagen4Fast = ImageModel(
    name = "Imagen4Fast", modelName = "imagen-4.0-fast-generate-001", maxPrompt = 2048, provider = APIProvider.Gemini, pricingFunction = { width, height ->
