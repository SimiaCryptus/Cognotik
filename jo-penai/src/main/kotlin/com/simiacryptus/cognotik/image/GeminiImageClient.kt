    ...
    return withReliability {
      withPerformanceLogging {
        try {
          ...
          log(Level.DEBUG, "Sending image generation request to Gemini SDK for model: ${request.model}", logStreams)

          val response: GenerateImagesResponse = client.models.generateImages(request.model, request.prompt, config)
