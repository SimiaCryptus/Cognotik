...
dependencies {
    ...
    compileOnly(project("$projectPrefix:platform-model"))
    ...
    compileOnly(project("$projectPrefix:platform-db"))
    ...
    testImplementation(project("$projectPrefix:platform-model"))
    ...
    testImplementation(project("$projectPrefix:platform-db"))
