...
*   **Key Features:**
    *   **Schema Generation:** Uses `TypeDescriber` to generate a YAML schema of class `T` and injects it into the system prompt.
...
*   **Prompt Strategy:** The prompt is dynamically generated to include the API description of the provided `symbols` using `TypeDescriber`.
