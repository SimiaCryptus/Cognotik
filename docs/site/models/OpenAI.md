...
OpenAI provides text-based chat models (GPT-4, GPT-4.1, GPT-4.5, GPT-5.x, and the "O" reasoning-focused series). All
models listed below support text input and text output only, as defined in Cognotik.
...
Pricing shown reflects the values defined in Cognotik at the time of writing; verify current rates with OpenAI before
